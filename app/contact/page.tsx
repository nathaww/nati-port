      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="p-8 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950">
            <h2 className="text-xl font-semibold mb-4">Schedule a Call</h2>
        ...
        <div className="p-8 rounded-2xl bg-emerald-50 dark:bg-emerald-950 border border-emerald-200 dark:border-emerald-800">
          <h2 className="text-2xl font-bold mb-4 text-emerald-900 dark:text-emerald-100">
            What to Expect
          </h2>
          <div className="grid md:grid-cols-2 gap-6 text-emerald-800 dark:text-emerald-200">
            <div>
              <h3 className="font-semibold mb-2">Response Time</h3>
              <p className="text-sm">I typically respond within 24-48 hours on weekdays.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm">East Africa Time (EAT / UTC+3)</p>
            </div>
            <div>
              <h3 className="font-semibold mb-2">Preferred Contact</h3>
              <p className="text-sm">Email for detailed discussions, LinkedIn for quick networking.</p>
            </div>
          </div>
        </div>
      </div>
